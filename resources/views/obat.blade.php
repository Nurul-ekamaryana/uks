...
<section class="content-header">
    <div class="container-fluid">
      <div class="row mb-3">
        <div class="col-sm-7">
          <h3 style="color: white;">Obat Pages</h3>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0 d-flex justify-content-between align-items-center">
            <h6 class="text-uppercase  text-sm font-weight-bolder" style="color: rgb(56, 56, 56)">Data Obat uks</h6>
          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
              <table id="myTable" class="display">
                <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Nama Obat</th>
                      
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-2">Jenis Obat</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class=" text-secondary text-sm font-weight-bolder opacity-14">{{ $siswa->jenis_obat }}</td>
                      <td class=" text-secondary text-sm font-weight-bolder opacity-14">{{ $siswa->ket }}</td>
                      <td class=" text-secondary text-sm font-weight-bolder opacity-14">{{ $siswa->created_at }}</td>
                
                      <td>
                        @if (Auth::user()->role !== 'petugas uks')
                        <form action="{{ route('obat.destroy', $siswa->id) }}" method="POST">
                            <a href="{{ route('obat.e dit', $siswa->id) }}" class="btn btn-outline-success btn-xm mb-0">
