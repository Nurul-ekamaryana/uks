            ...
            <div class="card-header pb-0 p-3">
              <div class="row">
                ...
                <div class="col-6 text-end">
                    <form action ="{{ route('siswa.update', $sM->id) }}"  method="POST">
                    @csrf
                    @method('PUT')
            ...
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-md-6 mb-md-0 mb-4">
                  ...
                  name="nis" type="text" style="border: 1px solid rgb(156, 154, 154);" value="{{ $sM->nis}}" readonly>
                  @error('nis')
                  <p>{{ $message }}</p>
                  @enderror
                </div>
                <div class="col-md-6 mb-md-0 mb-4">
                  <input class="card card-body border form-control card-plain border-radius-lg d-flex align-items-center flex-row" 
                  name="name" type="text" style="border: 1px solid rgb(156, 154, 154);" value="{{$sM->name}}">
                  @error('name')
                  <p>{{ $message }}</p>
                  @enderror
                </div>
