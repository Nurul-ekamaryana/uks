            ...
            <div class="card-header pb-0 p-3">
              <div class="row">
                ...
                <div class="col-6 text-end">
                        <form method="POST" action="{{ route('record.siswa', $record->id) }}">
                    @csrf
                    @method('PUT')
                  <input class="btn bg-gradient-dark mb-0" type="submit"></input>
                  <a class="btn bg-gradient-primary mb-0" href="{{url('record')}}"></i>Kembali</a>
                  <a class="btn bg-gradient-warning mb-0" href="{{url('pulang', $record->id)}}"></i>pdf</a>
                </div>
              </div>
            </div>
            <div class="card-body p-3">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-md-0 mb-4">
                        ...
                        name="keluhan" type="text" style="border: 1px solid rgb(156, 154, 154);" value="{{$record->keluhan}}" placeholder="3x1" readonly>
                        @error('keluhan')
                        <p>{{ $message }}</p>
                        @enderror
                      </div>
