    ...
    <div class="row">
          ...
          <div class="card mt-4">
            ...
            <div class="card-body p-3">
                ...
                <div class="col-md-6 mb-md-0 mb-4">
                    ...
                    name="username" type="text" style="border: 1px solid rgb(156, 154, 154);" value="{{$users->username}}" readonly>
                    @error('username')
                    <p>{{ $message }}</p>
                    @enderror
                  </div>
                ...
                <div class="col-md-6 mb-md-0 mb-4">
                    <input class="card card-body border form-control card-plain border-radius-lg d-flex align-items-center flex-row" 
                    name="name" type="text" style="border: 1px solid rgb(156, 154, 154);" value="{{$users->name}}" placeholder="Nurul Eka">
                    @error('name')
                    <p>{{ $message }}</p>
                    @enderror
                  </div>
      ...
      <div class="col-md-6 mb-md-0 mb-4">
        <select name="role" class="form-control" style="border: 1px solid rgb(88, 88, 88);">
            <option value="petugas uks" @if($users->role === 'petugas uks') selected @endif>Petugas uks</option>    
